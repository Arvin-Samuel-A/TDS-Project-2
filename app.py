...
def manage_github_email_json(params: Dict) -> str:
    return "https://raw.githubusercontent.com/Arvin-Samuel-A/TDS/refs/heads/main/email.json"
...
def publish_github_pages(params: Dict) -> str:
    return "https://arvin-samuel-a.github.io/TDS/"
...
def simulate_colab_auth(params: Dict) -> str:
    ...
    try:
        ...
        email = params.get("email", "23f2000627@ds.study.iitm.ac.in")
...
def push_json_to_github(params: Dict) -> str:
    return "https://tds-gt95ceoh7-arvin-samuel-as-projects.vercel.app/api"
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "email": {
                        "type": "string",
                        "description": "The email address to use in the simulation (default: 23f2000627@ds.study.iitm.ac.in)"
                    }
                },
                "required": []
            }
